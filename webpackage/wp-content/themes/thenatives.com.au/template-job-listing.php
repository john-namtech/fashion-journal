        ...
        <div class="subMeta">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                    <a href="<?php echo bloginfo('url') ?>"><h4 class="titleGrey">EMPLOYER LOGIN</h4></a>
                </div>
            </div>
        </div>
        <div class="jobContent">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                    ...
                    <div class="listingApply Apply-left">
                        <div class="btnApply pull-left">
                            <a href="" class="textApply">APPLY NOW</a>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
                    <div class="listingApply Apply-right pull-right">
                        <div class="btnApply pull-left">
                            <a href="<?php echo bloginfo('url') ?>" class="textApply">APPLY NOW</a>
                        </div>
                        <div class="strokeApply pull-right"></div>
                    </div>
