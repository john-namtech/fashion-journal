...
class Thenatives {
	...
	protected function initArrFunctions(){
		$this->arrFunctions = array('filter_theme','sidebar','general','header','footer','style','pagination','navigation');
	}
	...
	public function themestyle() {
        wp_register_script( 'main-script', THEME_JS . "/main.js", array('jquery') );
        wp_enqueue_script('main-script');
        wp_register_script( 'bootstrap-script', THEME_JS . "/bootstrap.min.js", array('jquery') );
        ...
        wp_register_script( 'slick-script', THEME_JS . "/slick.min.js", array('jquery') );
